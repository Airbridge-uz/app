...
const CHAT_SUGGESTIONS: SuggestionItem[] = [
	{
		...
		label: "Inspire Me",
		value: "Surprise me with a destination I'd love",
	},
	{
		icon: <Palmtree className="w-4 h-4" />,
		label: "Weekend Escape",
		value: "Suggest a quick weekend getaway",
	},
	{
		icon: <Compass className="w-4 h-4" />,
		label: "Hidden Gems",
		value: "What are some underrated destinations?",
	},
	{
		icon: <MapPin className="w-4 h-4" />,
		label: "Plan a Trip",
		value: "Help me plan my next adventure",
	},
];
...
const ANALYZE_SUGGESTIONS: SuggestionItem[] = [
	{
		...
		label: "Show cheapest",
		value: "Which of these is the cheapest option?",
	},
	{
		icon: <Zap className="w-4 h-4" />,
		label: "Show fastest",
		value: "Which flight is the fastest?",
	},
	{
		icon: <ArrowRightLeft className="w-4 h-4" />,
		label: "Direct flights",
		value: "Show me only direct flights",
	},
	{
		icon: <BarChart3 className="w-4 h-4" />,
		label: "Compare value",
		value: "Compare the best value options",
	},
];
	...
	return (
		<div className="flex flex-col items-center justify-center h-full px-4 py-12 w-full">
			...
			<div className="relative mb-8 flex-shrink-0 flex items-center justify-center">
				...
				<div
					...
					style={{
						...
						height: "160px",
						background:
							"radial-gradient(circle, rgba(255, 200, 50, 0.6) 0%, rgba(255, 170, 0, 0.3) 40%, transparent 70%)",
					}}
				/>
			...
			<div className="flex flex-wrap gap-2.5 justify-center max-w-lg">
				{(mode === "analyze" ? ANALYZE_SUGGESTIONS : CHAT_SUGGESTIONS).map(
					(suggestion) => (
						<button
