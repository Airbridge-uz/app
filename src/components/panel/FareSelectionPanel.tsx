...
export function FareSelectionPanel() {
    ...
    const [localSelectedFare, setLocalSelectedFare] = useState<FareOption | null>(selectedFare);
    ...
    const generateMockFareOptions = () => {
        ...
        setTimeout(() => {
            const basePrice = selectedFlight.price?.total ?? selectedFlight.price?.amount ?? 100;
    ...
    const estimatedCO2 = Math.round((selectedFlight.duration?.total_minutes || 180) * 0.15);
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-3">
                                <span className="text-lg font-semibold text-gray-900">{departureTime}</span>
                                <div className="flex items-center flex-1">
                                    <div className="h-px flex-1 bg-gray-300" />
                                    <span className="px-2 text-xs text-gray-500">{totalDuration}</span>
                                    <div className="h-px flex-1 bg-gray-300" />
                                </div>
                                <span className="text-lg font-semibold text-gray-900">{arrivalTime}</span>
                            </div>
                        ...
                        <div className="text-right">
                            <span className={cn(
                                ...
                                stopsCount === 0 ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'
                            )}>
                ...
                <div className="px-6 py-6">
                    <h2 className="text-lg font-semibold text-gray-900 mb-1">Select your fare</h2>
                    ...
                    {!isLoadingFares && fareOptions.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p className="text-gray-600 font-medium mb-1">No fare options available</p>
                    ...
                    {localSelectedFare ? (
                        <>
                            <div>
                                ...
                                <p className="font-semibold text-gray-900">{localSelectedFare.fare_brand_name}</p>
                            </div>
                            <div className="text-right">
