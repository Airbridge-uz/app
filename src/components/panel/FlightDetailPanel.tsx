...
import { ArrowRight, Clock, Briefcase, Utensils, Tv, Luggage } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="px-6 py-6">
                    <h2 className="text-lg font-semibold text-gray-900 mb-4">Selected flight</h2>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2 text-base font-semibold text-gray-900">
                                    ...
                                    <span>{outboundSlice?.departure.time?.slice(0, 5)} - {outboundSlice?.arrival.time?.slice(0, 5)}</span>
                                </div>
                            ...
                            <div className="text-right">
                                <div className="text-base font-semibold text-gray-900">{totalDuration}</div>
                                <div className="text-sm text-gray-500">
                    ...
                    {returnSlice && (
                        <>
                            ...
                            <h3 className="text-md font-semibold text-gray-900 mb-4">Return flight</h3>
                            <FlightTimeline
                                slice={returnSlice}
                                airlineName={selectedFlight.airline?.name}
                                className="mb-6"
