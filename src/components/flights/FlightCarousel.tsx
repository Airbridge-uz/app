...
export function FlightCarousel({ flights, onSelectFlight, onShowAll }: FlightCarouselProps) {
    ...
    const scrollTo = (direction: 'left' | 'right') => {
        ...
        const cardWidth = container.querySelector('.flight-card-item')?.clientWidth || 400;
